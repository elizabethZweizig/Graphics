...
function positionImagePlaneVertices() {
  ...
  */
  ...
  // Placeholder positioning for the vertices
  plane.geometry.vertices[0].z =
    plane.geometry.vertices[1].z =
      plane.geometry.vertices[2].z =
        plane.geometry.vertices[3].z = 500;
