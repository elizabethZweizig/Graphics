...
function placeIntersects(){
  ...
  */
  ...
  transform.getInverse(transformationMatrix);
  console.log(transform);

    var greenRay = new THREE.Vector3();
    greenRay = greenBall.position.clone().normalize();
    greenRay.applyMatrix4(transform);

    var redRay = new THREE.Vector3();
    redRay = redBall.position.clone().normalize();
    redRay.applyMatrix4(transform)

    var center = sphere.position;

    var e = new THREE.Vector3();
    e.subVectors(center, redBall.position.clone().applyMatrix4(transform));

    var d = new THREE.Vector3();
    d.subVectors(redBall.position.clone().applyMatrix4(transform), greenBall.position.clone().applyMatrix4(transform)).normalize();
    ...
    point.add(redBall.position.clone().applyMatrix4(transform));
    //console.log(point);

    intersect2.position.x = point.x;
    intersect2.position.y = point.y;
    intersect2.position.z = point.z;
    intersect2.position.applyMatrix4(transformationMatrix);
    intersect2.updateMatrix();
    //

    var e1 = new THREE.Vector3();
    e1.subVectors(center, greenBall.position.clone().applyMatrix4(transform));

    var d1 = new THREE.Vector3();
    d1.subVectors(greenBall.position.clone().applyMatrix4(transform), redBall.position.clone().applyMatrix4(transform)).normalize();
    ...
    point2.add(greenBall.position.clone().applyMatrix4(transform));
    intersect1.position.x = point2.x;
    intersect1.position.y = point2.y;
    intersect1.position.z = point2.z;
    intersect1.position.applyMatrix4(transformationMatrix);
