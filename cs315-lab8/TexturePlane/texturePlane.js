...
function updatePlane(){
  ...
  */
  plane.geometry.faceVertexUvs[0][0][0].set(0, 1/params.zoom);
  plane.geometry.faceVertexUvs[0][0][1].set(0, 0);
  plane.geometry.faceVertexUvs[0][0][2].set(1/params.zoom, 1/params.zoom);
  plane.geometry.faceVertexUvs[0][1][0].set(0, 0);
  plane.geometry.faceVertexUvs[0][1][1].set(1/params.zoom, 0);
  plane.geometry.faceVertexUvs[0][1][2].set(1/params.zoom, 1/params.zoom);
