...
function positionObjects() {
  ...
  */
  ...
  surfacePointBall.getWorldPosition(point);
  normal.subVectors(point, sphereObj.position);
  normal.normalize();
  normal.setLength(params.length);
  coneObj.position.set(point.x + normal.x, point.y + normal.y, point.z + normal.z);
