...
function setTBallPosition() {
  ...
  var x = Math.pow(1-params.t, 3) * v0.position.x + 3*Math.pow(1-params.t, 2)*params.t*v1.position.x + 3*(1-params.t)*Math.pow(params.t, 2)*v2.position.x + Math.pow(params.t, 3)*v3.position.x;
  var y = Math.pow(1-params.t, 3) * v0.position.y + 3*Math.pow(1-params.t, 2)*params.t*v1.position.y + 3*(1-params.t)*Math.pow(params.t, 2)*v2.position.y + Math.pow(params.t, 3)*v3.position.y;
  var z = Math.pow(1-params.t, 3) * v0.position.z + 3*Math.pow(1-params.t, 2)*params.t*v1.position.z + 3*(1-params.t)*Math.pow(params.t, 2)*v2.position.z + Math.pow(params.t, 3)*v3.position.z;
