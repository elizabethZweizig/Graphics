...
function calculateIntersection() {
  ...
  /* TODO:
  Here's where you'll make your additions to the code to set the surfacePointBall
  ...
  */
  ...
  var normalInverse = new THREE.Vector3();
  normalInverse = iplane.normal.negate();

  // Find verticies from world space fo rhte trianlge of view

  var temp1 = rayObject.position.clone().normalize().dot(normalInverse)
  console.log(temp1);

  var temp2 = temp1/(rayObject.position.dot(normalInverse));
  console.log(temp2);

  var sect = new THREE.Vector3();
  sect.subVectors(greenBall.position, rayObject.position);
  sect.multiplyScalar(temp2);
  surfacePointBall.position.addVectors(rayObject.position, sect)
  console.log(surfacePointBall.position);
